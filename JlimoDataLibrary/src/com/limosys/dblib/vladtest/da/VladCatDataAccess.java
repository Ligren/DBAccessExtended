 ...
 *
 */
public abstract class VladCatDataAccess extends JLimoObject {

  public enum VladCatAccessType {
    NONE,
    ONEREC,
    LIST
  }

  public enum VladCatDataSetId {
    ONEREC_DEFAULT (VladCatAccessType.ONEREC),
    LIST_DEFAULT (VladCatAccessType.LIST);

    private VladCatAccessType accessType;
    private VladCatDataSetId(VladCatAccessType accessType) {
      this.accessType = accessType;
    }
    public VladCatAccessType getAccessType() {
  ...
  protected abstract boolean allowAccessTypeChange(VladCatAccessType accessType);
...
// *** Constructors: ***
public VladCatDataAccess() {
  initProps();
  initSearchProps();
}
public VladCatDataAccess(VladCatAccessType accessType, boolean useDefaultInstance) {
  initProps();
  initSearchProps();
  setAccessType(accessType, useDefaultInstance);
}
public VladCatDataAccess(VladCatAccessType accessType, Database db) {
  initProps();
  initSearchProps();
  setAccessType(accessType, db);
}
public VladCatDataAccess(VladCatAccessType accessType, StorageDataSet[] dsArr) {
  initProps();
  initSearchProps();
...
protected VladCatDataAccess(VladCatAccessType accessType, ReadWriteRow rwRow) {
  if (accessType == VladCatAccessType.NONE && rwRow == null)
    throw new DataSetException("Can't use this constructor with VladCatAccessType.NONE or null rwRow.");
  this.rwRow = rwRow;
  switch (accessType) {
    case ONEREC:
      curAccessType = VladCatAccessType.ONEREC;
      break;
    case LIST:
      curAccessType = VladCatAccessType.LIST;
      break;
    default:
      curAccessType = VladCatAccessType.NONE;
  }
}


// *** setAccessType Methods: ***
private VladCatAccessType curAccessType = VladCatAccessType.NONE;
public VladCatAccessType getAccessType() {
...
private void setCurrentDataSets() {
  VladCatDataSetId[] dsIds = getDataSetIds(curAccessType);
...
protected void setAccessType(VladCatAccessType accessType, boolean useDefaultInstance) {
  setAccessType(accessType, useDefaultInstance, null);
}
protected void setAccessType(VladCatAccessType accessType, boolean useDefaultInstance, DbAccessListener dbAccessListener) {
  ...
  switch (accessType) {
  case ONEREC:
    VladCatAccess aVladCatAccess0 = (useDefaultInstance ? VladCatAccess.getInstance() : new VladCatAccess());
    if (dbAccessListener!=null) {
      aVladCatAccess0.addDbAccessListener(dbAccessListener);
    }
    htDataSets.put(VladCatDataSetId.ONEREC_DEFAULT, aVladCatAccess0.getViewDataSet());
    curAccessType = VladCatAccessType.ONEREC;
    break;
  case LIST:
    VladCatAccessList aVladCatAccessList1 = (useDefaultInstance ? VladCatAccessList.getInstance() : new VladCatAccessList());
    if (dbAccessListener!=null) {
      aVladCatAccessList1.addDbAccessListener(dbAccessListener);
    }
    htDataSets.put(VladCatDataSetId.LIST_DEFAULT, aVladCatAccessList1.getViewDataSet());
    curAccessType = VladCatAccessType.LIST;
    break;
  default:
      curAccessType = VladCatAccessType.NONE;
...
protected void setAccessType(VladCatAccessType accessType, Database db) {
  setAccessType(accessType, db, null);
}

protected void setAccessType(VladCatAccessType accessType, Database db, DbAccessListener dbAccessListener) {
  if (!allowAccessTypeChange(accessType)) {
    throw new DataSetException("Can't change Access Type to " + accessType.toString());
  }
  htDataSets.clear();
  switch (accessType) {
    case ONEREC:
      VladCatAccess accsCls0_0 = new VladCatAccess(db);
      if (dbAccessListener!=null) {
        accsCls0_0.addDbAccessListener(dbAccessListener);
      }
      htDataSets.put(VladCatDataSetId.ONEREC_DEFAULT, accsCls0_0.getViewDataSet());
      curAccessType = VladCatAccessType.ONEREC;
      break;
    case LIST:
      VladCatAccessList accsCls1_0 = new VladCatAccessList(db);
      if (dbAccessListener!=null) {
        accsCls1_0.addDbAccessListener(dbAccessListener);
      }
      htDataSets.put(VladCatDataSetId.LIST_DEFAULT, accsCls1_0.getViewDataSet());
      curAccessType = VladCatAccessType.LIST;
      break;
    default:
      curAccessType = VladCatAccessType.NONE;
...
protected boolean setAccessType(VladCatAccessType accessType, StorageDataSet[] dsArr) {
  if (!allowAccessTypeChange(accessType)) {
    throw new DataSetException("Can't change Access Type to " + accessType.toString());
  }
  htDataSets.clear();
  VladCatDataSetId[] dsIds = getDataSetIds(accessType);
  ...
  switch (accessType) {
  case ONEREC:
    htDataSets.put(VladCatDataSetId.ONEREC_DEFAULT, dsArr[0]);
    curAccessType = VladCatAccessType.ONEREC;
    break;
  case LIST:
    htDataSets.put(VladCatDataSetId.LIST_DEFAULT, dsArr[0]);
    curAccessType = VladCatAccessType.LIST;
    break;
  default:
      curAccessType = VladCatAccessType.NONE;
...
protected Column[] getDesignColumns(VladCatDataSetId dsId) {
...
// *** DataSet Methods: ***
public VladCatDataSetId[] getDataSetIds(VladCatAccessType accessType) {
  int size = 0;
  for (VladCatDataSetId dsId : VladCatDataSetId.values()) {
    if (dsId.getAccessType()==accessType) size++;
  }
  VladCatDataSetId[] dsIdArr = new VladCatDataSetId[size];
  int i = 0;
  for (VladCatDataSetId dsId : VladCatDataSetId.values()) {
...
public ReadWriteRow getReadWriteRow() {
  ...
  if (curAccessType==VladCatAccessType.NONE) return null;
...
private java.util.Hashtable<VladCatDataSetId, StorageDataSet> htDataSets = new Hashtable<VladCatDataSetId,StorageDataSet>();
public StorageDataSet getDataSet(VladCatDataSetId dataSetId) {
  if (dataSetId.getAccessType()!=curAccessType) return null;
      return htDataSets.get(dataSetId);
}
protected void setDataSet(VladCatDataSetId dataSetId, StorageDataSet dataSet) {
  htDataSets.put(dataSetId, dataSet);
}
protected void clearDataSet(VladCatDataSetId dataSetId) {
...
protected DataSetException getPropertyNotAvailableException(String propName) {
  return new DataSetException(DataSetException.COLUMN_NOT_IN_ROW,
                              "Property " + propName + " not available in VladCatAccessType." + curAccessType);
}
...
//    if (getAccessType()!=VladCatAccessType._) {
//      if (construct_db!=null) {
//        this.setAccessType(VladCatAccessType._, construct_db);
//      } else {
//        this.setAccessType(VladCatAccessType._, false);
//      }
//    }
//    StorageDataSet sds = getDataSetMain();
