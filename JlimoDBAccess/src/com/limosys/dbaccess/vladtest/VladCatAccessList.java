...
public class VladCatAccessList {

  private static VladCatAccessList dfltInstance;  private Database dbAlias;
  ...
  public VladCatAccessList(Database db) {
    try {
      dbAlias = db;
      jbInit();
    } catch (Exception e) {
  ...
  public static VladCatAccessList getInstance(){ 
    if (dfltInstance==null) dfltInstance = new VladCatAccessList(); 
    return dfltInstance; 
  } 
  ...
  private void jbInit() throws Exception {
    ...
    pdsVLAD_CAT.setProcedure(new ProcedureDescriptor(dbAlias, "exec lsp_VLAD_CAT_S_v1", pRowSelect, true, Load.ALL));
